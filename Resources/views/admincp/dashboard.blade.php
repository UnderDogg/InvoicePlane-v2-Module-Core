                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-primary">
                            <div class="card-body pb-0">
                                <div class="btn-group float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="https://coreui.io/demo/#">Action</a>
                                        <a class="dropdown-item" href="https://coreui.io/demo/#">Another action</a>
                                        <a class="dropdown-item" href="https://coreui.io/demo/#">Something else here</a>
                                    </div>
                                </div>
                            ...
                            <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="card-chart1" height="70" width="292"
                                    style="display: block; width: 292px; height: 70px;"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-info">
                            ...
                            <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="card-chart2" height="70" width="292"
                                    style="display: block; width: 292px; height: 70px;"></canvas>
                                <div id="card-chart2-tooltip" class="chartjs-tooltip top" style="opacity: 0; left: 69.5576px; top: 115.837px;">
                                    <div class="tooltip-header">
                                        <div class="tooltip-header-item">February</div>
                                    </div>
                                    <div class="tooltip-body">
                                        <div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgb(38, 203, 253);"></span><span
                                                class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">18</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-warning">
                            ...
                            <div class="chart-wrapper mt-3" style="height:70px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="card-chart3" height="70" width="324"
                                    style="display: block; width: 324px; height: 70px;"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card text-white bg-danger">
                            ...
                            <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="card-chart4" height="70" width="292"
                                    style="display: block; width: 292px; height: 70px;"></canvas>
                                <div id="card-chart4-tooltip" class="chartjs-tooltip top" style="opacity: 0; left: 80px; top: 126.5px;">
                                    <div class="tooltip-header">
                                        <div class="tooltip-header-item">April</div>
                                    </div>
                                    <div class="tooltip-body">
                                        <div class="tooltip-body-item"><span class="tooltip-body-item-color" style="background-color: rgba(230, 230, 230, 0.2);"></span><span
                                                class="tooltip-body-item-label">My First dataset</span><span class="tooltip-body-item-value">45</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="chart-wrapper" style="height:300px;margin-top:40px;">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="main-chart" height="300" width="1351"
                                style="display: block; width: 1351px; height: 300px;"></canvas>
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-facebook">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-1" height="96" width="324" class="chartjs-render-monitor"
                                        style="display: block; width: 324px; height: 96px;"></canvas>
                                </div>
                            </div>
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-twitter">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-2" height="96" width="324" class="chartjs-render-monitor"
                                        style="display: block; width: 324px; height: 96px;"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-linkedin">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-3" height="96" width="324" class="chartjs-render-monitor"
                                        style="display: block; width: 324px; height: 96px;"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
                        ...
                        <div class="brand-card">
                            <div class="brand-card-header bg-google-plus">
                                ...
                                <div class="chart-wrapper">
                                    ...
                                    <canvas id="social-box-chart-4" height="96" width="324" class="chartjs-render-monitor"
                                        style="display: block; width: 324px; height: 96px;"></canvas>
                                </div>
                            </div>
                            <div class="brand-card-body">
