...
class LaratrustSetupTables extends Migration
{
    ...
    public function up()
    {
        ...
        // Create table for associating roles to staff and teams (Many To Many Polymorphic)
        ...
        // Create table for associating permissions to staff (Many To Many Polymorphic)
